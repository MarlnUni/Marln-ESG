export const marketingHeadFeatures = [
  { label: "E. Dashboard", icon: "🌱", route: "/rbac/marketing-head/e-dashboard", description: "Environment Performance Overview, KPI Summary, Alerts & Notices" },
  { label: "S. Dashboard", icon: "🤝", route: "/rbac/marketing-head/s-dashboard", description: "Social Performance Overview, KPI Summary, Alerts & Notices" },
  { label: "G. Dashboard", icon: "🏛️", route: "/rbac/marketing-head/g-dashboard", description: "Governance Performance Overview, KPI Summary, Alerts & Notices" },
  ...
  { label: "ESG Initiative", icon: "📢", route: "/rbac/marketing-head/campaigns", description: "Campaign Planning, Execution, Performance Metrics" },

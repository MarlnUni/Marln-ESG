export const marketingHeadFeatures = [
  { label: "E. Dashboard", icon: "📊", route: "/rbac/marketing-head", description: "Marketing Performance Overview, KPI Summary, Alerts & Notices" },
  { label: "S. Dashboard", icon: "📊", route: "/rbac/marketing-head", description: "Marketing Performance Overview, KPI Summary, Alerts & Notices" },
  { label: "G. Dashboard", icon: "📊", route: "/rbac/marketing-head", description: "Marketing Performance Overview, KPI Summary, Alerts & Notices" },
